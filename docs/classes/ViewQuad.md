[Rings WebGPU Engine API - v0.0.1](../README.md) / [Exports](../modules.md) / ViewQuad
...
- [constructor](ViewQuad.md#constructor)

### Properties

- [width](ViewQuad.md#width)
- [height](ViewQuad.md#height)
- [quadRenderer](ViewQuad.md#quadrenderer)
- [material](ViewQuad.md#material)
- [rendererPassState](ViewQuad.md#rendererpassstate)
- [quadShader](ViewQuad.md#quadshader)
- [name](ViewQuad.md#name)
- [\_instanceID](ViewQuad.md#_instanceid)
- [transform](ViewQuad.md#transform)
- [renderNode](ViewQuad.md#rendernode)
- [entityChildren](ViewQuad.md#entitychildren)
- [components](ViewQuad.md#components)
- [waitDisposeComponents](ViewQuad.md#waitdisposecomponents)
- [\_bound](ViewQuad.md#_bound)
- [\_boundWorld](ViewQuad.md#_boundworld)
- [\_isBoundChange](ViewQuad.md#_isboundchange)
- [\_isScene3D](ViewQuad.md#_isscene3d)
- [prefabRef](ViewQuad.md#prefabref)
- [serializeTag](ViewQuad.md#serializetag)
- [listeners](ViewQuad.md#listeners)
- [data](ViewQuad.md#data)

### Accessors

- [instanceID](ViewQuad.md#instanceid)
- [dispose](ViewQuad.md#dispose)
- [numChildren](ViewQuad.md#numchildren)
- [bound](ViewQuad.md#bound)
- [isScene3D](ViewQuad.md#isscene3d)
- [localPosition](ViewQuad.md#localposition)
- [localRotation](ViewQuad.md#localrotation)
- [localScale](ViewQuad.md#localscale)
- [localQuaternion](ViewQuad.md#localquaternion)
- [parent](ViewQuad.md#parent)
- [parentObject](ViewQuad.md#parentobject)
- [x](ViewQuad.md#x)
- [y](ViewQuad.md#y)
- [z](ViewQuad.md#z)
- [scaleX](ViewQuad.md#scalex)
- [scaleY](ViewQuad.md#scaley)
- [scaleZ](ViewQuad.md#scalez)
- [rotationX](ViewQuad.md#rotationx)
- [rotationY](ViewQuad.md#rotationy)
- [rotationZ](ViewQuad.md#rotationz)

### Methods

- [renderTarget](ViewQuad.md#rendertarget)
- [renderToViewQuad](ViewQuad.md#rendertoviewquad)
- [getObjectByName](ViewQuad.md#getobjectbyname)
- [addChild](ViewQuad.md#addchild)
- [removeChild](ViewQuad.md#removechild)
- [removeAllChild](ViewQuad.md#removeallchild)
- [removeSelf](ViewQuad.md#removeself)
- [removeChildByIndex](ViewQuad.md#removechildbyindex)
- [hasChild](ViewQuad.md#haschild)
- [removeFromParent](ViewQuad.md#removefromparent)
- [getChildByIndex](ViewQuad.md#getchildbyindex)
- [getChildByName](ViewQuad.md#getchildbyname)
- [update](ViewQuad.md#update)
- [onTransformLocalChange](ViewQuad.md#ontransformlocalchange)
- [waitUpdate](ViewQuad.md#waitupdate)
- [noticeComponents](ViewQuad.md#noticecomponents)
- [forChild](ViewQuad.md#forchild)
- [addComponent](ViewQuad.md#addcomponent)
- [getOrAddComponent](ViewQuad.md#getoraddcomponent)
- [removeComponent](ViewQuad.md#removecomponent)
- [hasComponent](ViewQuad.md#hascomponent)
- [getComponent](ViewQuad.md#getcomponent)
- [getComponentFromParent](ViewQuad.md#getcomponentfromparent)
- [getComponentsInChild](ViewQuad.md#getcomponentsinchild)
- [getComponents](ViewQuad.md#getcomponents)
- [getComponentsExt](ViewQuad.md#getcomponentsext)
- [getComponentsByProperty](ViewQuad.md#getcomponentsbyproperty)
- [clone](ViewQuad.md#clone)
- [instantiate](ViewQuad.md#instantiate)
- [notifyChange](ViewQuad.md#notifychange)
- [fixedUpdate](ViewQuad.md#fixedupdate)
- [lateUpdate](ViewQuad.md#lateupdate)
- [traverse](ViewQuad.md#traverse)
- [destroy](ViewQuad.md#destroy)
- [dispatchEvent](ViewQuad.md#dispatchevent)
- [addEventListener](ViewQuad.md#addeventlistener)
- [removeEventListener](ViewQuad.md#removeeventlistener)
- [removeEventListenerAt](ViewQuad.md#removeeventlistenerat)
- [removeAllEventListener](ViewQuad.md#removealleventlistener)
- [containEventListener](ViewQuad.md#containeventlistener)
- [hasEventListener](ViewQuad.md#haseventlistener)

## Constructors

### constructor

• **new ViewQuad**(`vs?`, `fs?`, `rtFrame`, `multisample?`, `f?`): [`ViewQuad`](ViewQuad.md)
...
• **quadRenderer**: [`MeshRenderer`](MeshRenderer.md)
...
• **quadShader**: [`QuadShader`](QuadShader.md)
...
▸ **renderTarget**(`view`, `viewQuad`, `command`): `void`
...
▸ **renderToViewQuad**(`view`, `viewQuad`, `command`, `colorTexture`): `void`
...
| `viewQuad` | [`ViewQuad`](ViewQuad.md) |
| `command` | `GPUCommandEncoder` |
| `colorTexture` | [`Texture`](Texture.md) |
