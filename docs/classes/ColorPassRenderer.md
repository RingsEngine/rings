[Rings WebGPU Engine API - v0.0.1](../README.md) / [Exports](../modules.md) / ColorPassRenderer
...
- [constructor](ColorPassRenderer.md#constructor)

### Properties

- [listeners](ColorPassRenderer.md#listeners)
- [data](ColorPassRenderer.md#data)
- [rendererPassState](ColorPassRenderer.md#rendererpassstate)
- [splitRendererPassState](ColorPassRenderer.md#splitrendererpassstate)
- [useRenderBundle](ColorPassRenderer.md#userenderbundle)
- [debugViewQuads](ColorPassRenderer.md#debugviewquads)
- [debugTextures](ColorPassRenderer.md#debugtextures)
- [renderContext](ColorPassRenderer.md#rendercontext)
- [\_rendererType](ColorPassRenderer.md#_renderertype)
- [\_rtFrame](ColorPassRenderer.md#_rtframe)

### Accessors

- [passType](ColorPassRenderer.md#passtype)

### Methods

- [dispatchEvent](ColorPassRenderer.md#dispatchevent)
- [destroy](ColorPassRenderer.md#destroy)
- [addEventListener](ColorPassRenderer.md#addeventlistener)
- [removeEventListener](ColorPassRenderer.md#removeeventlistener)
- [removeEventListenerAt](ColorPassRenderer.md#removeeventlistenerat)
- [removeAllEventListener](ColorPassRenderer.md#removealleventlistener)
- [containEventListener](ColorPassRenderer.md#containeventlistener)
- [hasEventListener](ColorPassRenderer.md#haseventlistener)
- [setRenderStates](ColorPassRenderer.md#setrenderstates)
- [getRenderContext](ColorPassRenderer.md#getrendercontext)
- [setIrradiance](ColorPassRenderer.md#setirradiance)
- [compute](ColorPassRenderer.md#compute)
- [nodeUpload](ColorPassRenderer.md#nodeupload)
- [renderOp](ColorPassRenderer.md#renderop)
- [renderTr](ColorPassRenderer.md#rendertr)
- [renderBundleOp](ColorPassRenderer.md#renderbundleop)
- [renderBundleTr](ColorPassRenderer.md#renderbundletr)
- [recordRenderBundleNode](ColorPassRenderer.md#recordrenderbundlenode)
- [drawRenderNodes](ColorPassRenderer.md#drawrendernodes)
- [render](ColorPassRenderer.md#render)
- [drawNodes](ColorPassRenderer.md#drawnodes)
- [occlusionRenderNodeTest](ColorPassRenderer.md#occlusionrendernodetest)

## Constructors

### constructor

• **new ColorPassRenderer**(): [`ColorPassRenderer`](ColorPassRenderer.md)
...
gfx/renderJob/passRenderer/color/ColorPassRenderer.ts:16
...
gfx/renderJob/passRenderer/color/ColorPassRenderer.ts:21
...
gfx/renderJob/passRenderer/color/ColorPassRenderer.ts:129
...
gfx/renderJob/passRenderer/color/ColorPassRenderer.ts:181
