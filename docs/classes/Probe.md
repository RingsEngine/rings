[Rings WebGPU Engine API - v0.0.1](../README.md) / [Exports](../modules.md) / Probe
...
- [constructor](Probe.md#constructor)

### Properties

- [name](Probe.md#name)
- [\_instanceID](Probe.md#_instanceid)
- [transform](Probe.md#transform)
- [renderNode](Probe.md#rendernode)
- [entityChildren](Probe.md#entitychildren)
- [components](Probe.md#components)
- [waitDisposeComponents](Probe.md#waitdisposecomponents)
- [\_bound](Probe.md#_bound)
- [\_boundWorld](Probe.md#_boundworld)
- [\_isBoundChange](Probe.md#_isboundchange)
- [\_isScene3D](Probe.md#_isscene3d)
- [prefabRef](Probe.md#prefabref)
- [serializeTag](Probe.md#serializetag)
- [listeners](Probe.md#listeners)
- [data](Probe.md#data)
- [index](Probe.md#index)
- [drawCallFrame](Probe.md#drawcallframe)

### Accessors

- [instanceID](Probe.md#instanceid)
- [dispose](Probe.md#dispose)
- [numChildren](Probe.md#numchildren)
- [bound](Probe.md#bound)
- [isScene3D](Probe.md#isscene3d)
- [localPosition](Probe.md#localposition)
- [localRotation](Probe.md#localrotation)
- [localScale](Probe.md#localscale)
- [localQuaternion](Probe.md#localquaternion)
- [parent](Probe.md#parent)
- [parentObject](Probe.md#parentobject)
- [x](Probe.md#x)
- [y](Probe.md#y)
- [z](Probe.md#z)
- [scaleX](Probe.md#scalex)
- [scaleY](Probe.md#scaley)
- [scaleZ](Probe.md#scalez)
- [rotationX](Probe.md#rotationx)
- [rotationY](Probe.md#rotationy)
- [rotationZ](Probe.md#rotationz)

### Methods

- [getObjectByName](Probe.md#getobjectbyname)
- [addChild](Probe.md#addchild)
- [removeChild](Probe.md#removechild)
- [removeAllChild](Probe.md#removeallchild)
- [removeSelf](Probe.md#removeself)
- [removeChildByIndex](Probe.md#removechildbyindex)
- [hasChild](Probe.md#haschild)
- [removeFromParent](Probe.md#removefromparent)
- [getChildByIndex](Probe.md#getchildbyindex)
- [getChildByName](Probe.md#getchildbyname)
- [update](Probe.md#update)
- [onTransformLocalChange](Probe.md#ontransformlocalchange)
- [waitUpdate](Probe.md#waitupdate)
- [noticeComponents](Probe.md#noticecomponents)
- [forChild](Probe.md#forchild)
- [addComponent](Probe.md#addcomponent)
- [getOrAddComponent](Probe.md#getoraddcomponent)
- [removeComponent](Probe.md#removecomponent)
- [hasComponent](Probe.md#hascomponent)
- [getComponent](Probe.md#getcomponent)
- [getComponentFromParent](Probe.md#getcomponentfromparent)
- [getComponentsInChild](Probe.md#getcomponentsinchild)
- [getComponents](Probe.md#getcomponents)
- [getComponentsExt](Probe.md#getcomponentsext)
- [getComponentsByProperty](Probe.md#getcomponentsbyproperty)
- [clone](Probe.md#clone)
- [instantiate](Probe.md#instantiate)
- [notifyChange](Probe.md#notifychange)
- [fixedUpdate](Probe.md#fixedupdate)
- [lateUpdate](Probe.md#lateupdate)
- [traverse](Probe.md#traverse)
- [destroy](Probe.md#destroy)
...
- [removeEventListenerAt](Probe.md#removeeventlistenerat)
- [removeAllEventListener](Probe.md#removealleventlistener)
- [containEventListener](Probe.md#containeventlistener)
- [hasEventListener](Probe.md#haseventlistener)

## Constructors

### constructor

• **new Probe**(): [`Probe`](Probe.md)
...
gfx/renderJob/passRenderer/ddgi/Probe.ts:6
...
gfx/renderJob/passRenderer/ddgi/Probe.ts:4

___

### drawCallFrame

• **drawCallFrame**: `number` = `-1`

#### Defined in

gfx/renderJob/passRenderer/ddgi/Probe.ts:5
