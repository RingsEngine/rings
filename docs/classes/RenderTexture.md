[Rings WebGPU Engine API - v0.0.1](../README.md) / [Exports](../modules.md) / RenderTexture
...
- [constructor](RenderTexture.md#constructor)

### Properties

- [name](RenderTexture.md#name)
- [url](RenderTexture.md#url)
- [gpuTexture](RenderTexture.md#gputexture)
- [pid](RenderTexture.md#pid)
- [view](RenderTexture.md#view)
- [gpuSampler](RenderTexture.md#gpusampler)
- [gpuSampler\_comparison](RenderTexture.md#gpusampler_comparison)
- [format](RenderTexture.md#format)
- [usage](RenderTexture.md#usage)
- [width](RenderTexture.md#width)
- [height](RenderTexture.md#height)
- [depthOrArrayLayers](RenderTexture.md#depthorarraylayers)
- [numberLayer](RenderTexture.md#numberlayer)
- [viewDescriptor](RenderTexture.md#viewdescriptor)
- [textureDescriptor](RenderTexture.md#texturedescriptor)
- [visibility](RenderTexture.md#visibility)
- [textureBindingLayout](RenderTexture.md#texturebindinglayout)
- [samplerBindingLayout](RenderTexture.md#samplerbindinglayout)
- [sampler\_comparisonBindingLayout](RenderTexture.md#sampler_comparisonbindinglayout)
- [flipY](RenderTexture.md#flipy)
- [isVideoTexture](RenderTexture.md#isvideotexture)
- [isHDRTexture](RenderTexture.md#ishdrtexture)
- [mipmapCount](RenderTexture.md#mipmapcount)
- [\_textureChange](RenderTexture.md#_texturechange)
- [\_stateChangeRef](RenderTexture.md#_statechangeref)
- [resolveTarget](RenderTexture.md#resolvetarget)
- [sampleCount](RenderTexture.md#samplecount)
- [autoResize](RenderTexture.md#autoresize)
- [clear](RenderTexture.md#clear)

### Accessors

- [useMipmap](RenderTexture.md#usemipmap)
- [sourceImageData](RenderTexture.md#sourceimagedata)
- [addressModeU](RenderTexture.md#addressmodeu)
- [addressModeV](RenderTexture.md#addressmodev)
- [addressModeW](RenderTexture.md#addressmodew)
- [magFilter](RenderTexture.md#magfilter)
- [minFilter](RenderTexture.md#minfilter)
- [mipmapFilter](RenderTexture.md#mipmapfilter)
- [lodMinClamp](RenderTexture.md#lodminclamp)
- [lodMaxClamp](RenderTexture.md#lodmaxclamp)
- [compare](RenderTexture.md#compare)
- [maxAnisotropy](RenderTexture.md#maxanisotropy)

### Methods

- [init](RenderTexture.md#init)
- [createTextureDescriptor](RenderTexture.md#createtexturedescriptor)
- [generate](RenderTexture.md#generate)
- [getMipmapCount](RenderTexture.md#getmipmapcount)
- [updateTextureDescription](RenderTexture.md#updatetexturedescription)
- [updateGPUTexture](RenderTexture.md#updategputexture)
- [getGPUTexture](RenderTexture.md#getgputexture)
- [getGPUView](RenderTexture.md#getgpuview)
- [bindStateChange](RenderTexture.md#bindstatechange)
- [unBindStateChange](RenderTexture.md#unbindstatechange)
- [noticeChange](RenderTexture.md#noticechange)
- [destroy](RenderTexture.md#destroy)
- [delayDestroyTexture](RenderTexture.md#delaydestroytexture)
- [destroyTexture](RenderTexture.md#destroytexture)
- [resize](RenderTexture.md#resize)
- [create](RenderTexture.md#create)
- [clone](RenderTexture.md#clone)
- [readTextureToImage](RenderTexture.md#readtexturetoimage)

## Constructors

### constructor

• **new RenderTexture**(`width`, `height`, `format?`, `useMipMap?`, `usage?`, `numberLayer?`, `sampleCount?`, `clear?`, `autoResize?`): [`RenderTexture`](RenderTexture.md)
...
textures/RenderTexture.ts:134

___

### clone

▸ **clone**(): [`RenderTexture`](RenderTexture.md)
