[Rings WebGPU Engine API - v0.0.1](../README.md) / [Exports](../modules.md) / DepthCubeArrayTexture

# Class: DepthCubeArrayTexture
...
- [constructor](DepthCubeArrayTexture.md#constructor)

### Properties

- [name](DepthCubeArrayTexture.md#name)
- [url](DepthCubeArrayTexture.md#url)
- [gpuTexture](DepthCubeArrayTexture.md#gputexture)
- [pid](DepthCubeArrayTexture.md#pid)
- [view](DepthCubeArrayTexture.md#view)
- [gpuSampler](DepthCubeArrayTexture.md#gpusampler)
- [gpuSampler\_comparison](DepthCubeArrayTexture.md#gpusampler_comparison)
- [format](DepthCubeArrayTexture.md#format)
- [usage](DepthCubeArrayTexture.md#usage)
- [width](DepthCubeArrayTexture.md#width)
- [height](DepthCubeArrayTexture.md#height)
- [depthOrArrayLayers](DepthCubeArrayTexture.md#depthorarraylayers)
- [numberLayer](DepthCubeArrayTexture.md#numberlayer)
- [viewDescriptor](DepthCubeArrayTexture.md#viewdescriptor)
- [textureDescriptor](DepthCubeArrayTexture.md#texturedescriptor)
- [visibility](DepthCubeArrayTexture.md#visibility)
- [textureBindingLayout](DepthCubeArrayTexture.md#texturebindinglayout)
- [samplerBindingLayout](DepthCubeArrayTexture.md#samplerbindinglayout)
- [sampler\_comparisonBindingLayout](DepthCubeArrayTexture.md#sampler_comparisonbindinglayout)
- [flipY](DepthCubeArrayTexture.md#flipy)
- [isVideoTexture](DepthCubeArrayTexture.md#isvideotexture)
- [isHDRTexture](DepthCubeArrayTexture.md#ishdrtexture)
- [mipmapCount](DepthCubeArrayTexture.md#mipmapcount)
- [\_textureChange](DepthCubeArrayTexture.md#_texturechange)
- [\_stateChangeRef](DepthCubeArrayTexture.md#_statechangeref)

### Accessors

- [useMipmap](DepthCubeArrayTexture.md#usemipmap)
- [sourceImageData](DepthCubeArrayTexture.md#sourceimagedata)
- [addressModeU](DepthCubeArrayTexture.md#addressmodeu)
- [addressModeV](DepthCubeArrayTexture.md#addressmodev)
- [addressModeW](DepthCubeArrayTexture.md#addressmodew)
- [magFilter](DepthCubeArrayTexture.md#magfilter)
- [minFilter](DepthCubeArrayTexture.md#minfilter)
- [mipmapFilter](DepthCubeArrayTexture.md#mipmapfilter)
- [lodMinClamp](DepthCubeArrayTexture.md#lodminclamp)
- [lodMaxClamp](DepthCubeArrayTexture.md#lodmaxclamp)
- [compare](DepthCubeArrayTexture.md#compare)
- [maxAnisotropy](DepthCubeArrayTexture.md#maxanisotropy)

### Methods

- [init](DepthCubeArrayTexture.md#init)
- [createTextureDescriptor](DepthCubeArrayTexture.md#createtexturedescriptor)
- [generate](DepthCubeArrayTexture.md#generate)
- [getMipmapCount](DepthCubeArrayTexture.md#getmipmapcount)
- [updateTextureDescription](DepthCubeArrayTexture.md#updatetexturedescription)
- [updateGPUTexture](DepthCubeArrayTexture.md#updategputexture)
- [getGPUTexture](DepthCubeArrayTexture.md#getgputexture)
- [getGPUView](DepthCubeArrayTexture.md#getgpuview)
- [bindStateChange](DepthCubeArrayTexture.md#bindstatechange)
- [unBindStateChange](DepthCubeArrayTexture.md#unbindstatechange)
- [noticeChange](DepthCubeArrayTexture.md#noticechange)
- [destroy](DepthCubeArrayTexture.md#destroy)
- [delayDestroyTexture](DepthCubeArrayTexture.md#delaydestroytexture)
- [destroyTexture](DepthCubeArrayTexture.md#destroytexture)
- [internalCreateBindingLayoutDesc](DepthCubeArrayTexture.md#internalcreatebindinglayoutdesc)
- [internalCreateTexture](DepthCubeArrayTexture.md#internalcreatetexture)
- [internalCreateView](DepthCubeArrayTexture.md#internalcreateview)
- [internalCreateSampler](DepthCubeArrayTexture.md#internalcreatesampler)

## Constructors

### constructor

• **new DepthCubeArrayTexture**(`width`, `height`, `numberLayer`): [`DepthCubeArrayTexture`](DepthCubeArrayTexture.md)
...
textures/DepthCubeArrayTexture.ts:10
...
textures/DepthCubeArrayTexture.ts:17
...
textures/DepthCubeArrayTexture.ts:24
...
textures/DepthCubeArrayTexture.ts:38
...
textures/DepthCubeArrayTexture.ts:45
