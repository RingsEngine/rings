[Rings WebGPU Engine API - v0.0.1](../README.md) / [Exports](../modules.md) / PlaneGeometry
...
| `segmentW` | `number` | `1` |
| `segmentH` | `number` | `1` |
| `up` | [`Vector3`](Vector3.md) | `Vector3.Y_AXIS` |
