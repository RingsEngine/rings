[Rings WebGPU Engine API - v0.0.1](../README.md) / [Exports](../modules.md) / TextureCube
...
- [constructor](TextureCube.md#constructor)

### Properties

- [name](TextureCube.md#name)
- [url](TextureCube.md#url)
- [gpuTexture](TextureCube.md#gputexture)
- [pid](TextureCube.md#pid)
- [view](TextureCube.md#view)
- [gpuSampler](TextureCube.md#gpusampler)
- [gpuSampler\_comparison](TextureCube.md#gpusampler_comparison)
- [format](TextureCube.md#format)
- [usage](TextureCube.md#usage)
- [numberLayer](TextureCube.md#numberlayer)
- [viewDescriptor](TextureCube.md#viewdescriptor)
- [textureDescriptor](TextureCube.md#texturedescriptor)
- [sampler\_comparisonBindingLayout](TextureCube.md#sampler_comparisonbindinglayout)
- [flipY](TextureCube.md#flipy)
- [isVideoTexture](TextureCube.md#isvideotexture)
- [isHDRTexture](TextureCube.md#ishdrtexture)
- [mipmapCount](TextureCube.md#mipmapcount)
- [\_textureChange](TextureCube.md#_texturechange)
- [\_stateChangeRef](TextureCube.md#_statechangeref)
- [width](TextureCube.md#width)
- [height](TextureCube.md#height)
- [depthOrArrayLayers](TextureCube.md#depthorarraylayers)
- [visibility](TextureCube.md#visibility)
- [textureBindingLayout](TextureCube.md#texturebindinglayout)
- [samplerBindingLayout](TextureCube.md#samplerbindinglayout)

### Accessors

- [useMipmap](TextureCube.md#usemipmap)
- [sourceImageData](TextureCube.md#sourceimagedata)
- [addressModeU](TextureCube.md#addressmodeu)
- [addressModeV](TextureCube.md#addressmodev)
- [addressModeW](TextureCube.md#addressmodew)
- [magFilter](TextureCube.md#magfilter)
- [minFilter](TextureCube.md#minfilter)
- [mipmapFilter](TextureCube.md#mipmapfilter)
- [lodMinClamp](TextureCube.md#lodminclamp)
- [lodMaxClamp](TextureCube.md#lodmaxclamp)
- [compare](TextureCube.md#compare)
- [maxAnisotropy](TextureCube.md#maxanisotropy)

### Methods

- [init](TextureCube.md#init)
- [generate](TextureCube.md#generate)
- [getMipmapCount](TextureCube.md#getmipmapcount)
- [updateTextureDescription](TextureCube.md#updatetexturedescription)
- [updateGPUTexture](TextureCube.md#updategputexture)
- [getGPUTexture](TextureCube.md#getgputexture)
- [getGPUView](TextureCube.md#getgpuview)
- [bindStateChange](TextureCube.md#bindstatechange)
- [unBindStateChange](TextureCube.md#unbindstatechange)
- [noticeChange](TextureCube.md#noticechange)
- [destroy](TextureCube.md#destroy)
- [delayDestroyTexture](TextureCube.md#delaydestroytexture)
- [destroyTexture](TextureCube.md#destroytexture)
- [createTextureDescriptor](TextureCube.md#createtexturedescriptor)

## Constructors

### constructor

• **new TextureCube**(): [`TextureCube`](TextureCube.md)
...
gfx/graphics/webGpu/core/texture/TextureCube.ts:16
