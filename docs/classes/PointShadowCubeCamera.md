[Rings WebGPU Engine API - v0.0.1](../README.md) / [Exports](../modules.md) / PointShadowCubeCamera

# Class: PointShadowCubeCamera

## Hierarchy

- [`Object3D`](Object3D.md)

  ↳ **`PointShadowCubeCamera`**

## Table of contents

### Constructors

- [constructor](PointShadowCubeCamera.md#constructor)

### Properties

- [up\_camera](PointShadowCubeCamera.md#up_camera)
- [down\_camera](PointShadowCubeCamera.md#down_camera)
- [left\_camera](PointShadowCubeCamera.md#left_camera)
- [right\_camera](PointShadowCubeCamera.md#right_camera)
- [front\_camera](PointShadowCubeCamera.md#front_camera)
- [back\_camera](PointShadowCubeCamera.md#back_camera)
- [name](PointShadowCubeCamera.md#name)
- [\_instanceID](PointShadowCubeCamera.md#_instanceid)
- [transform](PointShadowCubeCamera.md#transform)
- [renderNode](PointShadowCubeCamera.md#rendernode)
- [entityChildren](PointShadowCubeCamera.md#entitychildren)
- [components](PointShadowCubeCamera.md#components)
- [waitDisposeComponents](PointShadowCubeCamera.md#waitdisposecomponents)
- [\_bound](PointShadowCubeCamera.md#_bound)
- [\_boundWorld](PointShadowCubeCamera.md#_boundworld)
- [\_isBoundChange](PointShadowCubeCamera.md#_isboundchange)
- [\_isScene3D](PointShadowCubeCamera.md#_isscene3d)
- [prefabRef](PointShadowCubeCamera.md#prefabref)
- [serializeTag](PointShadowCubeCamera.md#serializetag)
- [listeners](PointShadowCubeCamera.md#listeners)
- [data](PointShadowCubeCamera.md#data)

### Accessors

- [label](PointShadowCubeCamera.md#label)
- [instanceID](PointShadowCubeCamera.md#instanceid)
- [dispose](PointShadowCubeCamera.md#dispose)
- [numChildren](PointShadowCubeCamera.md#numchildren)
- [bound](PointShadowCubeCamera.md#bound)
- [isScene3D](PointShadowCubeCamera.md#isscene3d)
- [localPosition](PointShadowCubeCamera.md#localposition)
- [localRotation](PointShadowCubeCamera.md#localrotation)
- [localScale](PointShadowCubeCamera.md#localscale)
- [localQuaternion](PointShadowCubeCamera.md#localquaternion)
- [parent](PointShadowCubeCamera.md#parent)
- [parentObject](PointShadowCubeCamera.md#parentobject)
- [x](PointShadowCubeCamera.md#x)
- [y](PointShadowCubeCamera.md#y)
- [z](PointShadowCubeCamera.md#z)
- [scaleX](PointShadowCubeCamera.md#scalex)
- [scaleY](PointShadowCubeCamera.md#scaley)
- [scaleZ](PointShadowCubeCamera.md#scalez)
- [rotationX](PointShadowCubeCamera.md#rotationx)
- [rotationY](PointShadowCubeCamera.md#rotationy)
- [rotationZ](PointShadowCubeCamera.md#rotationz)

### Methods

- [initCubeCamera](PointShadowCubeCamera.md#initcubecamera)
- [getObjectByName](PointShadowCubeCamera.md#getobjectbyname)
- [addChild](PointShadowCubeCamera.md#addchild)
- [removeChild](PointShadowCubeCamera.md#removechild)
- [removeAllChild](PointShadowCubeCamera.md#removeallchild)
- [removeSelf](PointShadowCubeCamera.md#removeself)
- [removeChildByIndex](PointShadowCubeCamera.md#removechildbyindex)
- [hasChild](PointShadowCubeCamera.md#haschild)
- [removeFromParent](PointShadowCubeCamera.md#removefromparent)
- [getChildByIndex](PointShadowCubeCamera.md#getchildbyindex)
- [getChildByName](PointShadowCubeCamera.md#getchildbyname)
- [update](PointShadowCubeCamera.md#update)
- [onTransformLocalChange](PointShadowCubeCamera.md#ontransformlocalchange)
- [waitUpdate](PointShadowCubeCamera.md#waitupdate)
- [noticeComponents](PointShadowCubeCamera.md#noticecomponents)
- [forChild](PointShadowCubeCamera.md#forchild)
- [addComponent](PointShadowCubeCamera.md#addcomponent)
- [getOrAddComponent](PointShadowCubeCamera.md#getoraddcomponent)
- [removeComponent](PointShadowCubeCamera.md#removecomponent)
- [hasComponent](PointShadowCubeCamera.md#hascomponent)
- [getComponent](PointShadowCubeCamera.md#getcomponent)
- [getComponentFromParent](PointShadowCubeCamera.md#getcomponentfromparent)
- [getComponentsInChild](PointShadowCubeCamera.md#getcomponentsinchild)
- [getComponents](PointShadowCubeCamera.md#getcomponents)
- [getComponentsExt](PointShadowCubeCamera.md#getcomponentsext)
- [getComponentsByProperty](PointShadowCubeCamera.md#getcomponentsbyproperty)
- [clone](PointShadowCubeCamera.md#clone)
- [instantiate](PointShadowCubeCamera.md#instantiate)
- [notifyChange](PointShadowCubeCamera.md#notifychange)
- [fixedUpdate](PointShadowCubeCamera.md#fixedupdate)
- [lateUpdate](PointShadowCubeCamera.md#lateupdate)
- [traverse](PointShadowCubeCamera.md#traverse)
- [destroy](PointShadowCubeCamera.md#destroy)
- [dispatchEvent](PointShadowCubeCamera.md#dispatchevent)
- [addEventListener](PointShadowCubeCamera.md#addeventlistener)
- [removeEventListener](PointShadowCubeCamera.md#removeeventlistener)
- [removeEventListenerAt](PointShadowCubeCamera.md#removeeventlistenerat)
- [removeAllEventListener](PointShadowCubeCamera.md#removealleventlistener)
- [containEventListener](PointShadowCubeCamera.md#containeventlistener)
- [hasEventListener](PointShadowCubeCamera.md#haseventlistener)

## Constructors

### constructor

• **new PointShadowCubeCamera**(`near?`, `far?`, `fov?`, `isShadow?`): [`PointShadowCubeCamera`](PointShadowCubeCamera.md)
...
core/PointShadowCubeCamera.ts:23
...
core/PointShadowCubeCamera.ts:8
...
core/PointShadowCubeCamera.ts:9
...
core/PointShadowCubeCamera.ts:10
...
core/PointShadowCubeCamera.ts:11
...
core/PointShadowCubeCamera.ts:12
...
core/PointShadowCubeCamera.ts:13
...
core/PointShadowCubeCamera.ts:14
...
core/PointShadowCubeCamera.ts:33
