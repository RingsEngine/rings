...
export class TempPhyMath {
   ...
   */
  public static toBtQua(
    qua: Quaternion,
    btQua?: Ammo.btQuaternion
  ): Ammo.btQuaternion {
    btQua ||= this.tmpQuaA;
   ...
   */
  public static setBtVec(
    x: number,
    y: number,
    z: number,
    btVec?: Ammo.btVector3
  ): Ammo.btVector3 {
    btVec ||= this.tmpVecA;
   ...
   */
  public static eulerToBtQua(
    vec: Vector3,
    qua?: Ammo.btQuaternion
  ): Ammo.btQuaternion {
    qua ||= this.tmpQuaA;
    qua.setEulerZYX(
      vec.z * DEGREES_TO_RADIANS,
      vec.y * DEGREES_TO_RADIANS,
      vec.x * DEGREES_TO_RADIANS
    );
    return qua;
  }
