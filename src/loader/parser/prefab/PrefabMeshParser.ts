...
import {
  GeometryBase,
  LODDescriptor,
} from "../../../core/geometry/GeometryBase";
      ...
      if (useBlendShape) {
        ...
        for (let i = 0; i < prefabMesh.blendShapeData.blendCount; i++) {
          geometry.setAttribute(
            "a_morphPositions_" + i,
            prefabMesh.blendShapeData.blendShapePropertyDatas[i]
              .blendPositionList
          );
          geometry.setAttribute(
            "a_morphNormals_" + i,
            prefabMesh.blendShapeData.blendShapePropertyDatas[i].blendNormalList
          );
          for (let i = 0; i < prefabMesh.blendShapeData.blendCount; i++) {
