...
import {
  ...
  threshold,
  upSample,
} from "../../../assets/shader/compute/BloomEffect_cs";
...
export class BloomPost extends PostBase {
  ...
  private createResource() {
    ...
    this.RT_threshold = new VirtualTexture(
      screenWidth,
      screenHeight,
    ...
    const N = setting.downSampleStep;
    {
      ...
      for (let i = 0; i < N; i++) {
        this.RT_BloomDown[i] = new VirtualTexture(
          w,
          h,
          GPUTextureFormat.rgba16float,
          false,
...

    {
      ...
      for (let i = 0; i < N - 1; i++) {
        ...
        this.RT_BloomUp[i] = new VirtualTexture(
          w,
          h,
          GPUTextureFormat.rgba16float,
          false,
