...
export class TAAPost extends PostBase {
  ...
  private createCompute(view: View3D) {
    ...
    computeShader.setUniformBuffer(
      "globalUniform",
    ...
    computeShader.setSamplerTexture(
      `gBufferTexture`,
  ...
  private createResource() {
    ...
    this.preColorBuffer = new StorageGPUBuffer(
      w * h * 4,
      GPUBufferUsage.COPY_SRC
    );

    this.preColorTex = new VirtualTexture(
      w,
      h,
    ...
    this.taaTexture = new VirtualTexture(
      w,
      h,
      GPUTextureFormat.rgba16float,
      false,
    ...
    this.rtFrame = new RTFrame(
      [this.preColorTex, this.taaTexture, this.outTexture],
      [preColorDec, taaDec, outDec]
    );
  }
