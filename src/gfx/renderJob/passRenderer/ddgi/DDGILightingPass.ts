...
export class DDGILightingPass {
  ...
  constructor() {
    ...
    this.lightingTexture = new RenderTexture(
      giSetting.probeSourceTextureSize,
      giSetting.probeSourceTextureSize,
  ...
  private create(view: View3D) {
    ...
    this.computeShader.setUniformBuffer(
      "globalUniform",
      cameraBindGroup.uniformGPUBuffer
    );
    ...
    this.computeShader.setSamplerTexture(
      "prefilterMap",
      Engine3D.res.defaultSky
    );
  }
