export class GLSLLexerToken {
  ...
  public isBuiltinType(): boolean {
    return (
      this.Type > TokenType.BeginBuiltinType &&
      this.Type < TokenType.EndBuiltinType
    );
  }
  ...
  public isOperation(): boolean {
    return (
      this.Type > TokenType.BeginOperation && this.Type < TokenType.EndOperation
    );
  }
  ...
  public isAssignOperation(): boolean {
    return (
      this.Type > TokenType.BeginAssignOperation &&
      this.Type < TokenType.EndAssignOperation
    );
  }
