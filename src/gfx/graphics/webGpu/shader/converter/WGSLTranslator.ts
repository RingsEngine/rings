...
import {
  ShaderAttributeInfo,
  ShaderConverterResult,
  ShaderUniformInfo,
} from "./ShaderConverter";
import {
  SN_Declaration,
  SN_Layout,
  SN_Struct,
    ...
    while ((position = source.indexOf("gl_", position)) != -1) {
      ...
      switch (name) {
        ...
        case "gl_NumWorkGroups":
          context.stage = "compute";
          context.builtinIn.push(
            "@builtin(num_workgroups) gl_NumWorkGroups: vec3<u32>"
          );
          break;
        ...
        case "gl_LocalInvocationIndex":
          context.stage = "compute";
          context.builtinIn.push(
            "@builtin(local_invocation_index) gl_LocalInvocationIndex: u32"
          );
          break;
