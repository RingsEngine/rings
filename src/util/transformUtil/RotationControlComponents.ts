...
export class RotationControlComponents extends TransformControllerBaseComponent {
  protected applyLocalTransform(
    ...
    if (
      ...
      Matrix4.help_matrix_2.multiplyMatrices(
        Matrix4.help_matrix_1,
        Matrix4.help_matrix_0
      );
      Matrix4.help_matrix_2.invert();

      Matrix4.help_matrix_1.multiplyMatrices(
        Matrix4.help_matrix_2,
        Matrix4.help_matrix_0
      );
    ...
    if (
      ...
      switch (this.currentAxis) {
        case TransformAxisEnum.X:
          Matrix4.help_matrix_0.createByRotation(
