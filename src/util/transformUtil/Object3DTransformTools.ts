...
export class Object3DTransformTools extends Object3D {
  ...
  constructor() {
    ...
    this.mControllers[TransformMode.Scale] = this.addComponent(
      ScaleControlComponents
    );
    this.mControllers[TransformMode.Rotation] = this.addComponent(
      RotationControlComponents
    );
    this.mControllers[TransformMode.Translation] = this.addComponent(
  ...
  public selectTransformMode(transformMode: TransformMode) {
    if (this.mTransformMode == transformMode) return;
  ...
  public selectTransformSpaceMode(spaceMode: TransformSpaceMode) {
    if (this.mTransformSpaceType == spaceMode) return;
