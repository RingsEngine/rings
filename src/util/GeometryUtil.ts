...
export class GeometryUtil {
  ...
  public static mergeNumber(
    ...
    let posLen =
      geometries.getAttribute(VertexAttributeName.position).data.length / 3;
    ...
    let indexArray = geometries.getAttribute(VertexAttributeName.indices)
      .data as Int16Array;
