...
export class Navi3DEdge {
  ...
  constructor(point0: Navi3DPoint, point1: Navi3DPoint) {
    ...
    Navi3DPoint.CALC_VECTOR3D1.setTo(
      point0.x - point1.x,
      point0.y - point1.y,
      point0.z - point1.z
    );
  ...
  public getFatPoint(pt: Navi3DPoint): Navi3DPointFat {
    if (pt == this._pointA) return this.fatPointA;
    return this.fatPointB;
  }

  public getAnotherFatPoint(pt: Navi3DPoint): Navi3DPointFat {
    if (pt == this._pointA) return this.fatPointB;
    return this.fatPointA;
  }

  public getAnotherPoint(pt: Navi3DPoint): Navi3DPoint {
    if (pt == this._pointA) return this._pointB;
    return this._pointA;
  }

  public containsPoint(pt: Vector3): Navi3DPoint {
    if (Navi3DPoint.equalPoint(pt, this._pointA)) return this._pointA;
    if (Navi3DPoint.equalPoint(pt, this._pointB)) return this._pointB;
    return null;
  }
  ...
  public getEqualPoint(p: Vector3): Navi3DPoint {
    if (Navi3DPoint.equalPoint(p, this._pointA)) return this._pointA;
    if (Navi3DPoint.equalPoint(p, this._pointB)) return this._pointB;
    return null;
  }
  ...
  public get walkAble(): boolean {
    return (
      (this._edgeMask & Navi3DMaskType.WalkAble) == Navi3DMaskType.WalkAble
    );
  }
