...
export class PropertyAnimationClip {
  ...
  public positionCurves: Map<string, AnimationCurveT> = new Map<
    string,
    AnimationCurveT
  >();
  public rotationCurves: Map<string, AnimationCurveT> = new Map<
    string,
    AnimationCurveT
  >();
  public scaleCurves: Map<string, AnimationCurveT> = new Map<
    string,
    AnimationCurveT
  >();
  public floatCurves: Map<string, AnimationCurveT> = new Map<
    string,
    AnimationCurveT
  >();
