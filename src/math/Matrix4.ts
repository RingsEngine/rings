import {
  ...
  FloatArray,
  WasmMatrix,
} from "@rings/wasm-matrix/WasmMatrix";
...
export class Matrix4 {
  ...
  public static allocMatrix(allocCount: number) {
    ...
    this.dynamicGlobalMatrixRef.forEach((m) => {
      ...
      m.rawData = CreateFloatArray(
        Matrix4.dynamicMatrixBytes.buffer,
        m.offset,
        16
      );
    });
  ...
  public invers33() {
    ...
    let fDet: number =
      data[0] * rkInverse_00 + data[4] * rkInverse_10 + data[8] * rkInverse_20;
   ...
   * @internal
   */
  public makeMatrix44ByQuaternion(
    pos: Vector3,
    scale: Vector3,
    rot: Quaternion
  ) {
 ...
 * @internal
 */
export function multiplyMatrices4x4REF(
  lhs: Matrix4,
  rhs: Matrix4,
  res: Matrix4
) {
