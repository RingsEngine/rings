...
export class MemoryInfo {
  ...
  public setVector2Array(vs: Vector2[]) {
    for (let i = 0; i < vs.length; i++) {
      const element = vs[i];
      this.dataBytes.setFloat32(
        (i * 2 + 0) * Float32Array.BYTES_PER_ELEMENT,
        element.x,
        true
      );
      this.dataBytes.setFloat32(
        (i * 2 + 1) * Float32Array.BYTES_PER_ELEMENT,
        element.y,
        true
      );
    }
  ...
  public setVector3Array(vs: Vector3[]) {
    for (let i = 0; i < vs.length; i++) {
      const element = vs[i];
      this.dataBytes.setFloat32(
        (i * 3 + 0) * Float32Array.BYTES_PER_ELEMENT,
        element.x,
        true
      );
      this.dataBytes.setFloat32(
        (i * 3 + 1) * Float32Array.BYTES_PER_ELEMENT,
        element.y,
        true
      );
      this.dataBytes.setFloat32(
        (i * 3 + 2) * Float32Array.BYTES_PER_ELEMENT,
        element.z,
        true
      );
    }
  ...
  public setVector4Array(vs: Vector3[] | Vector4[] | Quaternion[]) {
    for (let i = 0; i < vs.length; i++) {
      const element = vs[i];
      this.dataBytes.setFloat32(
        (i * 4 + 0) * Float32Array.BYTES_PER_ELEMENT,
        element.x,
        true
      );
      this.dataBytes.setFloat32(
        (i * 4 + 1) * Float32Array.BYTES_PER_ELEMENT,
        element.y,
        true
      );
      this.dataBytes.setFloat32(
        (i * 4 + 2) * Float32Array.BYTES_PER_ELEMENT,
        element.z,
        true
      );
      this.dataBytes.setFloat32(
        (i * 4 + 3) * Float32Array.BYTES_PER_ELEMENT,
        element.w,
        true
      );
    }
  ...
  public getFloat(index: number = 0): number {
    return this.dataBytes.getFloat32(
  ...
  public getUint16(index: number = 0): number {
    return this.dataBytes.getUint16(
  ...
  public getUint32(index: number = 0): number {
    return this.dataBytes.getUint32(
  ...
  public setArray(index: number, data: number[]) {
    for (let i = 0; i < data.length; i++) {
      ...
      this.dataBytes.setFloat32(
        (index + i) * Float32Array.BYTES_PER_ELEMENT,
        element,
        true
      );
    }
  ...
  public setFloat32Array(index: number, data: Float32Array) {
    let tmp = new Float32Array(
      ...
      this.dataBytes.byteOffset + index * Float32Array.BYTES_PER_ELEMENT,
      data.length
    );
    tmp.set(data);
  }
  ...
  public setInt8Array(index: number, data: Int8Array) {
    let tmp = new Int8Array(
      this.dataBytes.buffer,
      this.dataBytes.byteOffset + index * Int8Array.BYTES_PER_ELEMENT
    );
    tmp.set(data);
  }

  public setInt16Array(index: number, data: Int16Array) {
    let tmp = new Int16Array(
      this.dataBytes.buffer,
      this.dataBytes.byteOffset + index * Int16Array.BYTES_PER_ELEMENT
    );
    tmp.set(data);
  }

  public setInt32Array(index: number, data: Int32Array) {
    let tmp = new Int32Array(
      this.dataBytes.buffer,
      this.dataBytes.byteOffset + index * Int32Array.BYTES_PER_ELEMENT
    );
    tmp.set(data);
  }
  ...
  public setUint8Array(index: number, data: Uint8Array) {
    let tmp = new Uint8Array(
      this.dataBytes.buffer,
      this.dataBytes.byteOffset + index * Uint8Array.BYTES_PER_ELEMENT
    );
    tmp.set(data);
  }

  public setUint16Array(index: number, data: Uint16Array) {
    let tmp = new Uint16Array(
      this.dataBytes.buffer,
      this.dataBytes.byteOffset + index * Uint16Array.BYTES_PER_ELEMENT
    );
    tmp.set(data);
  }

  public setUint32Array(index: number, data: Uint32Array) {
    let tmp = new Uint32Array(
      this.dataBytes.buffer,
      this.dataBytes.byteOffset + index * Uint32Array.BYTES_PER_ELEMENT
    );
    tmp.set(data);
  }
  ...
  public writeFloat32Array(v: Float32Array) {
    new Float32Array(
      this.dataBytes.buffer,
      this.dataBytes.byteOffset + this.offset
    ).set(v);
