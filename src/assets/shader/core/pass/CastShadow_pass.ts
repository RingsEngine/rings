...
export let shadowCastMap_vert: string = `
...
export let castPointShadowMap_vert: string = `
#include "WorldMatrixUniform"
#include "GlobalUniform"
...
export let shadowCastMap_frag: string = `
    #if USE_ALPHACUT
      @group(1) @binding(0)
...
export let directionShadowCastMap_frag: string = `
    #if USE_ALPHACUT
        @group(1) @binding(0)
        var baseMapSampler: sampler;
        @group(1) @binding(1)
